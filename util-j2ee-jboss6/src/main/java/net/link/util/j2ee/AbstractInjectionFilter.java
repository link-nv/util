...
/**
 * Abstract Injection Filter. <p/> <ul> <li>Injects EJBs. <li>Injects filter init parameters. If no defaultValue is specified, an {@link
 * UnavailableException} will be thrown. <li>Injects filter context parameters. If no defaultValue is specified, an {@link
 * UnavailableException} will be thrown. </ul>
 *
 * @author wvdhaute
 */
