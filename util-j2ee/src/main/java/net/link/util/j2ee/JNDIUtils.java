...
public class JNDIUtils {
    ...
    public static <T> T getComponent(final String jndiName, final Class<T> type) {

        return getComponent( INITIAL_CONTEXT.get(), jndiName, type );
    }

    public static <T> T getComponent(Context context, final String jndiName, final Class<T> type) {
