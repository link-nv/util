...
public abstract class TypeUtils {
     ...
     */
    @NotNull
    public static <T, A extends Annotation> Map<Class<? super T>, Map<Class<?>, A>> getAnnotations(final Class<T> type, final Class<A> annotationType) {
     ...
     */
    public static <T, R> R forEachSuperTypeOf(@NotNull final Class<T> type, @Nullable final Function<LastResult<Class<?>, R>, R> typeFunction,
     ...
     * @return The final result produced by the last execution of the operation.
     */
    public static <T, R> R forEachFieldOf(final Class<T> type, final Function<LastResult<Field, R>, R> function, @Nullable final R firstResult,
